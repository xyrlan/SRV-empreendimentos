  ...
  return (
    <main id='home' className="flex min-h-screen flex-col items-center justify-between">
      <ImagesSliderProvider>
        <h1 className="font-bold text-3xl lg:text-5xl 2xl:text-6xl text-center bg-clip-text text-transparent bg-gradient-to-b from-primary-500 to-primary-800 py-4 brightness-125">
          Consultoria de valuation e venda<br />de indústrias, empresas e startups.
        </h1>
        <p className="font-medium max-w-2xl md:text-lg lg:text-2xl text-center bg-clip-text text-transparent bg-gradient-to-b to-secondary-400 from-secondary-100 py-4 brightness-125">
