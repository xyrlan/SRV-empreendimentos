    ...
    <section id="call2" className="w-full flex flex-col items-center justify-center py-28 md:py-36 relative gap-5 px-6 mt-10">
      ...
      <div className='flex flex-col items-center justify-center gap-7 text-center z-20'>
        <div className='font-medium'>
          <h2 className='md:text-3xl text-2xl text-secondary-800 my-2 drop-shadow-xl'>Você merece a melhor consultoria</h2>
          <h3 className='md:text-3xl text-2xl text-secondary-700'>Conte com nossa equipe de especialistas para o que for preciso!</h3>
        </div>
        <CallButton />
      </div>
    </section>
