...
export default function Call2Section() {
  return (
    <section id="call2" className="w-full flex flex-col items-center justify-center py-36 relative gap-5 px-6 mt-10">
      ...
      <div className='flex flex-col items-center justify-center gap-7 text-center z-20'>
        <div className='font-medium'>
          <h2 className='md:text-3xl text-2xl text-[#08003f] dark:text-[#aaa1e6] my-2'>Você merece a melhor consultoria</h2>
